# Taagat Design System

This guide explains how to use a React design system powered by:
...
Turborepo runs the `build` script for all publishable packages (excluding docs) and publishes the packages to npm. By default, this includes `taagat` as the npm organization.
